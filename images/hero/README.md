...
| `hero-color-original.jpg` | 沒有人物的原風景（備份／以後合成用）。網站目前**不讀**這張。 |

不要放進來的（實驗已放棄）：三層切圖、depth mesh、去背貼紙、inpaint 風景、water-mask。
